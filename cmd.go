...
func NewKubectlCommand(in io.Reader, out, err io.Writer) *cobra.Command {
	...
	groups := templates.CommandGroups{
		{
			...
			Commands: []*cobra.Command{
				...
				cmd.NewCmdExposeService(f, ioStreams),
				cmd.NewCmdRun(f, ioStreams),
				set.NewCmdSet(f, ioStreams),
				deprecatedAlias("run-container", cmd.NewCmdRun(f, ioStreams)),
			},
		},
		{
			Message: "Basic Commands (Intermediate):",
			Commands: []*cobra.Command{
				cmd.NewCmdExplain("kubectl", f, ioStreams),
				get.NewCmdGet("kubectl", f, ioStreams),
				cmd.NewCmdEdit(f, ioStreams),
				cmd.NewCmdDelete(f, ioStreams),
			},
		},
		{
			...
			Commands: []*cobra.Command{
				...
				cmd.NewCmdRollingUpdate(f, ioStreams),
				cmd.NewCmdScale(f, ioStreams),
				cmd.NewCmdAutoscale(f, ioStreams),
			},
		},
		{
			Message: "Cluster Management Commands:",
			Commands: []*cobra.Command{
				cmd.NewCmdCertificate(f, ioStreams),
				cmd.NewCmdClusterInfo(f, ioStreams),
				cmd.NewCmdTop(f, ioStreams),
				cmd.NewCmdCordon(f, ioStreams),
				cmd.NewCmdUncordon(f, ioStreams),
				cmd.NewCmdDrain(f, ioStreams),
				cmd.NewCmdTaint(f, ioStreams),
			},
		},
		{
			Message: "Troubleshooting and Debugging Commands:",
			Commands: []*cobra.Command{
				cmd.NewCmdDescribe("kubectl", f, ioStreams),
				cmd.NewCmdLogs(f, ioStreams),
				cmd.NewCmdAttach(f, ioStreams),
				cmd.NewCmdExec(f, ioStreams),
				cmd.NewCmdPortForward(f, ioStreams),
				cmd.NewCmdProxy(f, ioStreams),
				cmd.NewCmdCp(f, ioStreams),
		...
		},
		{
			...
			Commands: []*cobra.Command{
				cmd.NewCmdApply("kubectl", f, ioStreams),
				cmd.NewCmdPatch(f, ioStreams),
				cmd.NewCmdReplace(f, ioStreams),
				wait.NewCmdWait(f, ioStreams),
				cmd.NewCmdConvert(f, ioStreams),
			},
		},
		{
			Message: "Settings Commands:",
			Commands: []*cobra.Command{
				cmd.NewCmdLabel(f, ioStreams),
				cmd.NewCmdAnnotate("kubectl", f, ioStreams),
				cmd.NewCmdCompletion(ioStreams.Out, ""),
			},
		},
	}
	groups.Add(cmds)
	...
	alpha := cmd.NewCmdAlpha(f, ioStreams)
	...
	cmds.AddCommand(cmd.NewCmdPlugin(f, ioStreams))
	cmds.AddCommand(cmd.NewCmdVersion(f, ioStreams))
	cmds.AddCommand(cmd.NewCmdApiVersions(f, ioStreams))
	cmds.AddCommand(cmd.NewCmdApiResources(f, ioStreams))
	cmds.AddCommand(cmd.NewCmdOptions(ioStreams.Out))
